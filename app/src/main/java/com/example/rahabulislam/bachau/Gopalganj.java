...
public class Gopalganj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gopalganj);
...
//                String phone = workerPhone[position];
                ...
                Intent intent = new Intent(Gopalganj.this,AllHelpService.class);
